...
当前版本：0.0.6（2026-03-24） — 修复 SQL 编辑区复制/粘贴/剪切快捷键问题，新增右键剪贴板菜单，并持续优化 Monaco 查询编辑体验。
...
- SQL 查询编辑器提供轻量语法诊断（引号/括号未闭合、多语句提醒），并支持 `Ctrl/Cmd + Enter` 快速执行
- SQL 编辑区支持稳定的 `Cmd/Ctrl + C/X/V/A` 快捷键，并提供右键菜单（剪切/复制/粘贴/全选）
